...
void Angle_Calcu(void)	 
{
  ...
  // MPU6050_GetData(&AX, &AY, &AZ, &GX, &GY, &GZ);
	...
	if(Accel_x<32764) accx=Accel_x/4096;//计算x轴加速度
	else              accx=1-(Accel_x-49152)/4096;
	if(Accel_y<32764) accy=Accel_y/4096;//计算y轴加速度
	else              accy=1-(Accel_y-49152)/4096;
	if(Accel_z<32764) accz=Accel_z/4096;//计算z轴加速度
	else              accz=(Accel_z-49152)/4096;
